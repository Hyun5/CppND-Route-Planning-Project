...
static float UserInput(const std::string name) {
    char input [20];
...
{    
    ...
    // RoutePlanner object below in place of 10, 10, 90, 90.
  	float start_x = UserInput("start_x: ");
  	float start_y = UserInput("start_y: ");
  	float end_x = UserInput("end_x: ");
  	float end_y = UserInput("end_y: ");
